        ...
        <div class="col-md-3 col-sm-6">
            <div class="product-grid">
                <div class="product-image">
                    <a href="#">
                        <img class="pic-1" src="{{asset('images/'.$index['image_name']) }}">
                        <img class="pic-2" src="{{asset('images/'.$index['image_name']) }}">
                    </a>
                    <ul class="social">
                        <li><a onclick="location.href='/user/lihat{{$index->id}}'" data-tip="Quick View"><i class="fa fa-search"></i></a></li>
                        <li><a onclick="location.href='/user/addcart{{$index->id}}'" data-tip="Add To Cart"><i class="fa fa-shopping-cart"></i></a></li>
                    </ul>
                    <span class="product-new-label">Sale</span>
                    {{-- <span class="product-discount-label">20%</span> --}}
                </div>
                <ul class="rating">
                    @for ($i = 0; $i < $index->rate; $i++)
                        <li class="fa fa-star"></li>
                    @endfor
                    @for ($i = 5; $i > $index->rate; $index->rate++)
                        <li class="fa fa-star disable"></li>                        
                    @endfor
                </ul>
                <div class="product-content">
                    <h3 class="title"><a href="#">{{$index['product_name']}}</a></h3>
                    <div class="price">{{$index['discount']}}
